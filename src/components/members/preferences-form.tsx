...
// Preferências da experiência de aprendizado — compartilhado entre a área do
// aluno (/dashboard/configuracoes) e a área do colaborador dentro do painel
// admin (/admin/configuracoes, quando o usuário não é admin de verdade).
